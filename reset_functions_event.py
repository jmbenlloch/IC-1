...
#    pdb.set_trace()
    ...
    #One extra position
    sensor_starts   = pycuda.gpuarray.zeros(int(nsensors * nslices + 1), np.dtype('i4'))
    sensor_starts_d = sensor_starts.gpudata
...
#    grid_size  = 4
    ...
    sensor_voxel_probs(sensor_probs_d, sensor_starts_d, voxel_ids_d, nsensors,
